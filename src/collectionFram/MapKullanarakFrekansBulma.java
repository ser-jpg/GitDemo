...
// TreeMap kullanarak bie String in icindeki harflerin frekasini bulma.
public class MapKullanarakFrekansBulma {
    ...
    public static void main(String[] args) {
        ...
        for(Map.Entry<Character,Integer>entry:frekans.entrySet()){
            ...
            System.out.println("Karakter: "+entry.getKey()+" "+ entry.getValue());
        }
    }
